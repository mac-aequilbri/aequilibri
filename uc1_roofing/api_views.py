...
def detect_roof_features(request):
    ...
    _SOLAR_PANEL_GUIDANCE = (
        ...
        "  ✓ A dark blue, dark grey, or black rectangle on the roof that is clearly "
        "    darker than the surrounding roof material (tile, terracotta, Colorbond)\n"
        ...
        "  ✓ A reflective dark surface that contrasts strongly with the rest of the roof\n"
        "  ✓ Multiple rectangles arranged in a row or block on one roof slope\n"
        "  ✓ Even ONE row of 4+ panel-like rectangles\n"
        "  ✓ A raised rectangular structure casting a clean rectangular shadow\n\n"
        "ONLY say solar_panels=FALSE if you are confident the entire roof surface is "
        "uniformly tile/metal/membrane with no dark rectangular areas anywhere.\n\n"
        "When you say TRUE, confidence='medium' is acceptable — you do not need to be "
        "certain. Bias the entire judgement toward TRUE."
    )
