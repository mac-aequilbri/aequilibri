...
urlpatterns = [
    ...
    path('measurement-history/', views.measurement_history, name='measurement_history'),
    ...
    path('api/measurement-snapshot/', api_views.measurement_snapshot_save, name='measurement_snapshot_save'),
